...
export function useBookmark(props) {
  ...
  const handleClick = () => {
    ...
    fetch(`https://tech-new-main.vercel.app/users/canBookmark/${user.token}`)
      .then((res) => res.json())
      .then((data) => {
...
export function useFetchArticles() {
  ...
  useEffect(() => {
    fetch("https://tech-new-main.vercel.app/articles")
...
export function useRegister() {
  ...
  function handleRegister() {
    ...
    fetch("https://tech-new-main.vercel.app/users/signup", {
      method: "POST",
...
export function useConnect() {
  ...
  function handleConnect() {
    fetch("https://tech-new-main.vercel.app/users/signin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
